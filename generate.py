...
def registry():
    from tvmaps import (maps_asturias, maps_capitals, maps_ciudades,
                        maps_comcap, maps_cotidiano, maps_editoriales,
                        maps_fisica, maps_gijon, maps_iconos, maps_marcas,
                        maps_marcas_logos, maps_moda, maps_productos,
                        maps_rios, maps_spain)
    ...
    for mod in (maps_spain, maps_asturias, maps_capitals, maps_ciudades,
                ...
                maps_iconos, maps_cotidiano, maps_gijon):
        for name in dir(mod):
